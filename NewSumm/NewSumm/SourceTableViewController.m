...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *node = [sources objectAtIndex:[indexPath row]];
    
    UIImageView *imageView = [cell viewWithTag:100];
    UILabel *source = [cell viewWithTag:101];
    UILabel *quote = [cell viewWithTag:102];
    
    imageView.image = [UIImage imageNamed:node[@"source"]];
    quote.text = node[@"sentence"];
    source.text = [UtilityMethods getPublicationName:node[@"source"]];
